...
class ConversationModel extends Model
{
    ...
    // (DIPERBAIKI) Tambahkan 'updated_at' ke dalam daftar yang diizinkan
    protected $allowedFields    = ['user1_id', 'user2_id', 'updated_at'];
    ...
    public function getConversationsForUser(int $userId)
    {
        ...
        $builder->select('
            ...
            (SELECT COALESCE(message, "Sebuah produk telah ditanyakan") FROM messages m WHERE m.conversation_id = c.id ORDER BY m.created_at DESC LIMIT 1) as last_message,
